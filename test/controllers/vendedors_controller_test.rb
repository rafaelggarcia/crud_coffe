...
class VendedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendedor" do
    assert_difference("Vendedor.count") do
      post vendedors_url, params: { vendedor: { cnpj: @vendedor.cnpj, razao_social: @vendedor.razao_social, site: @vendedor.site } }
    end
  ...
  test "should update vendedor" do
    patch vendedor_url(@vendedor), params: { vendedor: { cnpj: @vendedor.cnpj, razao_social: @vendedor.razao_social, site: @vendedor.site } }
